...
packs <- c('abind', 'acepack', 'ade4', 'arules', 'assertthat', 'audio', 'AzureML', 'backports', 'base', 'base64enc', 'BH', 'bindr', 'bindrcpp',
           ...
           'mime', 'miniCRAN', 'minqa', 'misc3d', 'mlapi', 'mnormt', 'ModelMetrics', 'modeltools', 'monitoR', 'multcomp', 'munsell', 'mvtnorm',
           'neuralnet', 'NeuralNetTools', 'ngram', 'nlme', 'nloptr', 'NLP', 'NMF', 'nnet', 'nnls', 'nplr', 'numbers', 'numDeriv', 'openssl', 'osmar',
           'parallel', 'party', 'partykit', 'pbapply', 'pbkrtest', 'pdc', 'pillar', 'pkgconfig', 'pkgmaker', 'PKI', 'plogr', 'plotly', 'plotmo',
           'plotrix', 'plyr', 'png', 'prabclus', 'praise', 'pROC', 'processx', 'prodlim', 'profileModel', 'proto', 'proxy', 'pryr', 'psych', 'purrr',
           'pwr', 'qap', 'qdapDictionaries', 'qdapRegex', 'qdapTools', 'quadprog', 'Quandl', 'quanteda', 'quantmod', 'quantreg', 'quickcheck',
           'qvcalc', 'R6', 'randomForest', 'RANN', 'raster', 'rbenchmark', 'rbokeh', 'RColorBrewer', 'Rcpp', 'RcppArmadillo', 'RcppEigen',
           'RcppExamples', 'RcppParallel', 'RcppRoll', 'RCurl', 'readr', 'recipes', 'recommenderlab', 'registry', 'rematch', 'reports', 'reshape',
           'reshape2', 'reticulate', 'rgexf', 'RgoogleMaps', 'rjazz', 'rjson', 'RJSONIO', 'rlang', 'rmarkdown', 'Rmixmod', 'rngtools', 'ROAuth',
