...
packs <- c('abind', 'acepack', 'ade4', 'arules', 'assertthat', 'AzureML', 'backports', 'base', 'base64enc', 'BH', 'bindr', 'bindrcpp', 'bit',
           ...
           'lightgbm', 'lme4', 'lmtest', 'locpol', 'logistf', 'lpSolve', 'magic', 'magrittr', 'manipulate', 'mapproj', 'maps', 'maptools', 'markdown',
           'MASS', 'Matrix', 'MatrixModels', 'mboost', 'mcclust', 'mclust', 'memoise', 'methods', 'Metrics', 'mgcv', 'mice', 'mime', 'miniCRAN',
           ...
           'pdc', 'pkgconfig', 'pkgmaker', 'PKI', 'plogr', 'plotly', 'plotmo', 'plotrix', 'plyr', 'png', 'prabclus', 'praise', 'processx', 'prodlim',
           'profileModel', 'proto', 'proxy', 'pryr', 'purrr', 'pwr', 'qdapDictionaries', 'qdapRegex', 'qdapTools', 'quadprog', 'Quandl', 'quantmod',
           'quantreg', 'qvcalc', 'R6', 'randomForest', 'RANN', 'raster', 'rbenchmark', 'rbokeh', 'RColorBrewer', 'Rcpp', 'RcppArmadillo', 'RcppEigen',
           'RCurl', 'readr', 'registry', 'rematch', 'reports', 'reshape2', 'reticulate', 'rgexf', 'RgoogleMaps', 'rjazz', 'rjson', 'RJSONIO', 'rlang',
           'rmarkdown', 'rngtools', 'ROAuth', 'robustbase', 'ROCR', 'Rook', 'roxygen2', 'rpart', 'rpart.plot', 'rprojroot', 'rredis', 'RSclient',
           'Rserve', 'RSQLite', 'rstudioapi', 'RUnit', 'rversions', 'rworldmap', 'sandwich', 'scales', 'scatterplot3d', 'segmented', 'shiny', 'slam',
           'sn', 'SnowballC', 'sourcetools', 'sp', 'spam', 'SparseM', 'spatial', 'splines', 'splus2R', 'sqldf', 'stabs', 'stats', 'stats4', 'streamR',
