...
packs <- c('abind', 'acepack', 'ade4', 'arules', 'askpass', 'assertthat', 'audio', 'AzureML', 'backports', 'base', 'base64enc', 'BH', 'bibtex',
           ...
           'data.table', 'datasets', 'DBI', 'dbplyr', 'ddalpha', 'debugme', 'deepboost', 'deepnet', 'deldir', 'dendextend', 'DEoptimR', 'desc',
           'devtools', 'DiagrammeR', 'dichromat', 'digest', 'dimRed', 'diptest', 'doParallel', 'dotCall64', 'downloader', 'dplyr', 'DRR', 'DT',
           'dtplyr', 'dtw', 'e1071', 'earth', 'ellipse', 'entropy', 'evaluate', 'extrafont', 'extrafontdb', 'FactoMineR', 'fansi', 'fastmatch',
