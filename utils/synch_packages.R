...
packs <- c('abind', 'acepack', 'adagio', 'ade4', 'admisc', 'AlgDesign', 'arules', 'ash', 'askpass', 'assertthat', 'AUC', 'audio', 'backports',
           ...
           'pillar', 'pixmap', 'pkgbuild', 'pkgconfig', 'pkgdown', 'pkgload', 'pkgmaker', 'PKI', 'plogr', 'plot3D', 'plotly', 'plotmo', 'plotrix',
           'pls', 'plyr', 'png', 'polyclip', 'polycor', 'polynom', 'pool', 'prabclus', 'pracma', 'praise', 'prettyunits', 'pricesensitivitymeter',
           'pROC', 'processx', 'prodlim', 'profileModel', 'progress', 'progressr', 'promises', 'proto', 'proxy', 'proxyC', 'pryr', 'ps', 'psych',
           ...
           'spatstat.data', 'spatstat.geom', 'spatstat.linnet', 'spatstat.random', 'spatstat.sparse', 'spatstat.utils', 'spData', 'splines',
           ...
           'TSP', 'TTR', 'tuneR', 'tweenr', 'twitteR', 'tzdb', 'ucminf', 'units', 'urca', 'urltools', 'uroot', 'usethis', 'utf8', 'utils', 'uuid',
           'vcd', 'vctrs', 'vegan', 'viridis', 'viridisLite', 'visNetwork', 'vroom', 'vscDebugger', 'waldo', 'waterfalls', 'webshot', 'whisker',
