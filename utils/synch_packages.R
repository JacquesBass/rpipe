...
packs <- c('abind', 'acepack', 'ade4', 'arules', 'assertthat', 'AzureML', 'backports', 'base', 'base64enc', 'BH', 'bindr', 'bindrcpp', 'bit',
           ...
           'proto', 'proxy', 'pryr', 'purrr', 'pwr', 'qdapDictionaries', 'qdapRegex', 'qdapTools', 'quadprog', 'Quandl', 'quantmod', 'quantreg',
           'qvcalc', 'R6', 'randomForest', 'RANN', 'raster', 'rbenchmark', 'rbokeh', 'RColorBrewer', 'Rcpp', 'RcppArmadillo', 'RcppEigen', 'RCurl',
           'readr', 'registry', 'rematch', 'reports', 'reshape2', 'reticulate', 'rgexf', 'RgoogleMaps', 'rjazz', 'rjson', 'RJSONIO', 'rlang',
