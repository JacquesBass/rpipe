...
packs <- c('abind', 'acepack', 'ade4', 'arules', 'askpass', 'assertthat', 'audio', 'AzureML', 'backports', 'base', 'base64enc', 'BH', 'bibtex',
           ...
           'DiagrammeR', 'dichromat', 'digest', 'dimRed', 'diptest', 'doParallel', 'dotCall64', 'downloader', 'dplyr', 'DRR', 'DT', 'dtplyr', 'dtw',
           'e1071', 'earth', 'ellipse', 'ellipsis', 'entropy', 'evaluate', 'extrafont', 'extrafontdb', 'FactoMineR', 'fansi', 'farver', 'fastmatch',
           ...
           'gdtools', 'gender', 'generics', 'geometry', 'geosphere', 'ggforce', 'ggmap', 'ggplot2', 'ggraph', 'ggrepel', 'ggthemes', 'gh', 'gistr',
           'git2r', 'glmnet', 'glue', 'gmodels', 'gmp', 'goftest', 'googlesheets', 'googleVis', 'gower', 'gplots', 'graphics', 'grDevices', 'grid',
           'gridBase', 'gridExtra', 'gsubfn', 'gtable', 'gtools', 'gutenbergr', 'h2o', 'h5', 'haven', 'hexbin', 'highlight', 'highr', 'Hmisc', 'hms',
           'htmlTable', 'htmltools', 'htmlwidgets', 'httpuv', 'httr', 'hunspell', 'ifultools', 'igraph', 'imager', 'influenceR', 'ini', 'inline',
           'inum', 'ipred', 'irlba', 'ISOcodes', 'iterators', 'janeaustenr', 'jomo', 'jpeg', 'jsonlite', 'kerasR', 'kernlab', 'KernSmooth', 'klaR',
           'knitr', 'labeling', 'labelled', 'lambda.r', 'lars', 'lasso2', 'later', 'lattice', 'latticeExtra', 'lava', 'lazyeval', 'lda', 'leaflet',
           ...
           'pls', 'plyr', 'png', 'polyclip', 'pool', 'prabclus', 'praise', 'prettyunits', 'pROC', 'processx', 'prodlim', 'profileModel', 'progress',
           'promises', 'proto', 'proxy', 'pryr', 'ps', 'psych', 'purrr', 'pwr', 'qap', 'qdapDictionaries', 'qdapRegex', 'qdapTools', 'qpdf',
           ...
           'RcppParallel', 'RcppProgress', 'RcppRoll', 'RCurl', 'readbitmap', 'readr', 'readxl', 'recipes', 'recommenderlab', 'registry', 'rematch',
           ...
           'sf', 'sfsmisc', 'shiny', 'shinyBS', 'shinydashboard', 'shinyjs', 'signal', 'slam', 'sn', 'sna', 'snow', 'SnowballC', 'sourcetools', 'sp',
