...
packs <- c('abind', 'acepack', 'adagio', 'ade4', 'admisc', 'AlgDesign', 'arules', 'ash', 'askpass', 'assertthat', 'AUC', 'audio', 'backports',
           ...
           'downloader', 'dplyr', 'DRR', 'DT', 'dtplyr', 'dtw', 'e1071', 'earth', 'EBImage', 'ellipse', 'ellipsis', 'entropy', 'eRm', 'evaluate',
           'expm', 'extrafont', 'extrafontdb', 'factoextra', 'FactoMineR', 'fansi', 'farver', 'fastmap', 'fastmatch', 'fclust', 'fda', 'fds', 'ff',
           'fftwtools', 'fields', 'fImport', 'flashClust', 'flexclust', 'flexmix', 'float', 'FNN', 'fontawesome', 'forcats', 'foreach', 'forecast',
           'foreign', 'formatR', 'Formula', 'formula.tools', 'fpc', 'fracdiff', 'fs', 'functional', 'futile.logger', 'futile.options', 'future',
           'future.apply', 'gargle', 'gbm', 'gbRd', 'gclus', 'gdata', 'gdtools', 'gender', 'generics', 'geometry', 'geosphere', 'gert', 'ggforce',
           ...
           'mitools', 'mlapi', 'mlbench', 'mlogit', 'mnormt', 'ModelMetrics', 'modelr', 'modeltools', 'monitoR', 'msm', 'multcomp', 'multicool',
           'munsell', 'mvtnorm', 'NbClust', 'ndjson', 'netrankr', 'network', 'neuralnet', 'NeuralNetTools', 'ngram', 'nlme', 'nloptr', 'NLP', 'NMF',
           'nnet', 'nnls', 'nortest', 'nplr', 'numbers', 'numDeriv', 'OAIHarvester', 'officer', 'opencage', 'openssl', 'openxlsx', 'operator.tools',
           ...
           'spatstat', 'spatstat.core', 'spatstat.data', 'spatstat.geom', 'spatstat.linnet', 'spatstat.random', 'spatstat.sparse', 'spatstat.utils',
           'spData', 'splines', 'splus2R', 'sqldf', 'SQUAREM', 'stabs', 'statmod', 'statnet.common', 'stats', 'stats4', 'stopwords', 'streamR',
