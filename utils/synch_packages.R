...
packs <- c('abind', 'acepack', 'ade4', 'arules', 'assertthat', 'AzureML', 'backports', 'base', 'base64enc', 'BH', 'bindr', 'bindrcpp', 'bit',
           'bit64', 'bitops', 'blob', 'Boom', 'BoomSpikeSlab', 'boot', 'BradleyTerry2', 'brew', 'brglm', 'broom', 'bsts', 'car', 'caret',
           ...
           'minqa', 'misc3d', 'mnormt', 'ModelMetrics', 'modeltools', 'multcomp', 'munsell', 'mvtnorm', 'neuralnet', 'NeuralNetTools', 'ngram',
           'nlme', 'nloptr', 'NLP', 'NMF', 'nnet', 'nnls', 'nplr', 'numbers', 'numDeriv', 'openssl', 'osmar', 'parallel', 'party', 'partykit',
           'pbapply', 'pbkrtest', 'pdc', 'pkgconfig', 'pkgmaker', 'PKI', 'plogr', 'plotly', 'plotmo', 'plotrix', 'plyr', 'png', 'prabclus', 'praise',
