...
packs <- c('abind', 'acepack', 'adagio', 'ade4', 'arules', 'askpass', 'assertthat', 'audio', 'backports', 'base', 'base64enc', 'BH', 'bibtex',
           ...
           'reticulate', 'rex', 'rgdal', 'rgexf', 'RgoogleMaps', 'rio', 'rjazz', 'rjson', 'RJSONIO', 'rlang', 'rmarkdown', 'Rmixmod', 'rngtools',
           'ROAuth', 'robustbase', 'ROCR', 'Rook', 'roxygen2', 'rpart', 'rpart.plot', 'rprojroot', 'rredis', 'RSclient', 'rsconnect', 'Rserve',
           'RSpectra', 'RSQLite', 'rstudioapi', 'Rttf2pt1', 'RUnit', 'rversions', 'rvest', 'rvg', 'rworldmap', 'sandwich', 'satellite', 'scales',
           'scatterplot3d', 'seewave', 'segmented', 'selectr', 'seriation', 'sessioninfo', 'sf', 'sfsmisc', 'shiny', 'shinyBS', 'shinydashboard',
           'shinyjs', 'signal', 'slam', 'sn', 'sna', 'snow', 'SnowballC', 'soundgen', 'sourcetools', 'sp', 'spa', 'spacyr', 'spam', 'SparseM',
           ...
           'sys', 'tau', 'tcltk', 'tclust', 'TeachingDemos', 'tensor', 'tensorflow', 'testthat', 'text2vec', 'textcat', 'tfruns', 'TH.data', 'tibble',
           'tidyr', 'tidyselect', 'tidytext', 'tidyverse', 'tiff', 'timeDate', 'timeline', 'timeSeries', 'tinytex', 'titanic', 'tm', 'tokenizers',
           'tools', 'topicmodels', 'transcribeR', 'treeClust', 'triangle', 'triebeard', 'trimcluster', 'tseries', 'tsne', 'TSP', 'TTR', 'tuneR',
           'tweenr', 'twitteR', 'ucminf', 'units', 'urca', 'urltools', 'uroot', 'USAboundaries', 'USAboundariesData', 'usethis', 'utf8', 'utils',
           'uuid', 'vcd', 'vctrs', 'viridis', 'viridisLite', 'visNetwork', 'waterfalls', 'webshot', 'whisker', 'withr', 'wmtsa', 'wordcloud', 'xfun',
           'xgboost', 'XML', 'xml2', 'xopen', 'xtable', 'xts', 'yaml', 'zeallot', 'zip', 'zipfR', 'zoo')
