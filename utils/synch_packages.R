...
packs <- c('abind', 'acepack', 'adagio', 'ade4', 'admisc', 'AlgDesign', 'arules', 'ash', 'askpass', 'assertthat', 'AUC', 'audio', 'backports',
           ...
           'coin', 'collections', 'colorspace', 'colourpicker', 'combinat', 'commonmark', 'compiler', 'config', 'conjoint', 'conquer', 'CORElearn',
           'corrplot', 'covr', 'cowplot', 'cpp11', 'crayon', 'credentials', 'crosstalk', 'crul', 'curl', 'CVST', 'cyclocomp', 'data.table',
           'datasets', 'DBI', 'dbplyr', 'dcurver', 'ddalpha', 'debugme', 'deepboost', 'deepnet', 'deldir', 'dendextend', 'DEoptimR', 'Deriv', 'desc',
           'deSolve', 'devtools', 'dfidx', 'DiagrammeR', 'dichromat', 'diffobj', 'digest', 'dimRed', 'diptest', 'doParallel', 'dotCall64', 'downlit',
           ...
           'forcats', 'foreach', 'forecast', 'foreign', 'formatR', 'Formula', 'formula.tools', 'fpc', 'fracdiff', 'fs', 'functional', 'futile.logger',
           'futile.options', 'future', 'future.apply', 'gargle', 'gbm', 'gbRd', 'gclus', 'gdata', 'gdtools', 'gender', 'generics', 'geometry',
           'geosphere', 'gert', 'ggforce', 'ggfortify', 'ggmap', 'ggplot2', 'ggpubr', 'ggraph', 'ggrepel', 'ggsci', 'ggsignif', 'ggthemes', 'gh',
           'gistr', 'git2r', 'gitcreds', 'globals', 'glue', 'gmodels', 'gmp', 'goftest', 'googledrive', 'googlesheets4', 'googleVis', 'gower',
           ...
           'htmltools', 'htmlwidgets', 'httpcode', 'httpuv', 'httr', 'hunspell', 'ids', 'igraph', 'influenceR', 'ini', 'inline', 'interp', 'inum',
           'ipred', 'irlba', 'isoband', 'ISOcodes', 'iterators', 'janeaustenr', 'jomo', 'jpeg', 'jquerylib', 'jsonlite', 'kerasR', 'kernlab',
           'KernSmooth', 'klaR', 'knitr', 'ks', 'labeling', 'labelled', 'lambda.r', 'languageserver', 'lars', 'lasso2', 'later', 'lattice',
           ...
           'spatstat.linnet', 'spatstat.random', 'spatstat.sparse', 'spatstat.utils', 'spData', 'splines', 'splus2R', 'sqldf', 'SQUAREM', 'stabs',
