...
packs <- c('abind', 'acepack', 'adagio', 'ade4', 'admisc', 'AlgDesign', 'alphavantager', 'anytime', 'arules', 'ash', 'askpass', 'assertthat', 'AUC',
           ...
           'readstata13', 'readxl', 'recipes', 'recommenderlab', 'recosystem', 'registry', 'rematch', 'rematch2', 'remotes', 'renv', 'reprex',
           'reshape', 'reshape2', 'reticulate', 'rex', 'rfm', 'rgdal', 'rgexf', 'RgoogleMaps', 'RhpcBLASctl', 'riingo', 'rio', 'rjazz', 'rjson',
           'RJSONIO', 'rlang', 'rle', 'rmarkdown', 'Rmixmod', 'Rmpfr', 'rngtools', 'ROAuth', 'robustbase', 'ROCR', 'Rook', 'roxygen2', 'rpart',
           'rpart.plot', 'rprojroot', 'RPushbullet', 'rsample', 'RSclient', 'rsconnect', 'Rserve', 'rsparse', 'RSpectra', 'RSQLite', 'rstatix',
           ...
           'shinyBS', 'shinydashboard', 'shinyjs', 'signal', 'SimDesign', 'slam', 'slider', 'sn', 'sna', 'snow', 'SnowballC', 'soundgen',
           'sourcetools', 'sp', 'spacyr', 'spam', 'SparseM', 'sparsepp', 'spatial', 'spatstat', 'spatstat.data', 'spatstat.explore', 'spatstat.geom',
           'spatstat.linnet', 'spatstat.model', 'spatstat.random', 'spatstat.sparse', 'spatstat.univar', 'spatstat.utils', 'spData', 'splines',
           'splus2R', 'sqldf', 'SQUAREM', 'stabs', 'stationaRy', 'statmod', 'statnet.common', 'stats', 'stats4', 'stopwords', 'streamR', 'stringdist',
           'stringi', 'stringr', 'strucchange', 'styler', 'survey', 'survival', 'svglite', 'sys', 'systemfonts', 'tau', 'tcltk', 'tclust',
           'TeachingDemos', 'tensor', 'tensorflow', 'terra', 'testthat', 'text2vec', 'textcat', 'textshaping', 'tfautograph', 'tfruns', 'TH.data',
           'tibble', 'tidygraph', 'tidyquant', 'tidyr', 'tidyselect', 'tidytext', 'tidyverse', 'tiff', 'timechange', 'timeDate', 'timeSeries',
           'timetk', 'tinytex', 'titanic', 'tm', 'tmvnsim', 'tokenizers', 'tools', 'topicmodels', 'transcribeR', 'treeClust', 'treemapify',
