...
packs <- c('abind', 'acepack', 'adagio', 'ade4', 'AlgDesign', 'arules', 'ash', 'askpass', 'assertthat', 'AUC', 'audio', 'backports', 'base',
           ...
           'lobstr', 'locfit', 'locpol', 'logistf', 'lpSolve', 'lsa', 'ltm', 'lubridate', 'magic', 'magrittr', 'manipulate', 'mapproj', 'maps',
           ...
           'mlapi', 'mlbench', 'mlogit', 'mnormt', 'ModelMetrics', 'modelr', 'modeltools', 'monitoR', 'msm', 'multcomp', 'multicool', 'munsell',
           'mvtnorm', 'NbClust', 'ndjson', 'netrankr', 'network', 'neuralnet', 'NeuralNetTools', 'ngram', 'nlme', 'nloptr', 'NLP', 'NMF', 'nnet',
           'nnls', 'nortest', 'nplr', 'numbers', 'numDeriv', 'OAIHarvester', 'officer', 'opencage', 'openssl', 'openxlsx', 'operator.tools',
           'ordinal', 'osmar', 'packrat', 'pan', 'parallel', 'party', 'partykit', 'pbapply', 'pbkrtest', 'pcaPP', 'pdc', 'pdftools', 'permute',
           'pheatmap', 'phonTools', 'pillar', 'pixmap', 'pkgbuild', 'pkgconfig', 'pkgdown', 'pkgload', 'pkgmaker', 'PKI', 'plogr', 'plot3D', 'plotly',
           'plotmo', 'plotrix', 'pls', 'plyr', 'png', 'polyclip', 'polycor', 'polynom', 'pool', 'prabclus', 'pracma', 'praise', 'prettyunits',
           ...
           'tensorflow', 'testthat', 'text2vec', 'textcat', 'textshaping', 'tfautograph', 'tfruns', 'TH.data', 'tibble', 'tidygraph', 'tidyr',
           ...
           'tweenr', 'twitteR', 'tzdb', 'ucminf', 'units', 'urca', 'urltools', 'uroot', 'usethis', 'utf8', 'utils', 'uuid', 'vcd', 'vctrs', 'vegan',
           'viridis', 'viridisLite', 'visNetwork', 'vroom', 'waldo', 'waterfalls', 'webshot', 'whisker', 'withr', 'wk', 'wordcloud', 'xfun',
