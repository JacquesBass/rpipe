...
packs <- c('abind', 'acepack', 'adagio', 'ade4', 'AlgDesign', 'arules', 'ash', 'askpass', 'assertthat', 'AUC', 'audio', 'backports', 'base',
           ...
           'R.utils', 'R6', 'ragg', 'rainbow', 'randomForest', 'RANN', 'rappdirs', 'raster', 'rbenchmark', 'rbibutils', 'rbokeh', 'rcmdcheck',
           'RcmdrMisc', 'RColorBrewer', 'Rcpp', 'RcppArmadillo', 'RcppEigen', 'RcppExamples', 'RcppParallel', 'RcppProgress', 'RcppRoll', 'RCurl',
           ...
           'spatstat', 'spatstat.data', 'spatstat.utils', 'spData', 'splines', 'splus2R', 'sqldf', 'SQUAREM', 'stabs', 'statmod', 'statnet.common',
           'stats', 'stats4', 'stopwords', 'streamR', 'stringdist', 'stringi', 'stringr', 'strucchange', 'styler', 'survey', 'survival', 'svglite',
           'sys', 'systemfonts', 'tau', 'tcltk', 'tclust', 'TeachingDemos', 'tensor', 'tensorflow', 'testthat', 'text2vec', 'textcat', 'textshaping',
