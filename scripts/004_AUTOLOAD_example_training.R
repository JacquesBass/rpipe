...
#>> always loaded and available for the scripts whose number is bigger than this one's. (Note: It's name starts with AUTOLOAD, that's why it loads.)
...
{
    # I have to load the required example_raw_as_binary explicitly, since it is not AUTOLOAD.
